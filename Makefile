...
TESTS = t_escframe t_miiframe t_physweep t_hostrx t_escclear t_pause t_faultcap t_wirefmt t_framesz t_txok t_crc t_resid3 t_escgate t_plsem t_ring t_pace
test: $(TESTS:%=tests/%)
